(* OASIS_START *)
(* DO NOT EDIT (digest: 0fd7b5bd94e31dde80cbf066b0420536) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("src/snappy", ["src"])];
     lib_c = [("snappy", "src", [])];
     flags =
       [
          ...
          (["oasis_library_snappy_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lsnappy"])]);
          (["oasis_library_snappy_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lsnappy"])])
       ];
     }
  ;;
