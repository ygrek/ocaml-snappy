...
(* OASIS_START *)
(* DO NOT EDIT (digest: 69b57bb6e3b4130c5eb3b4baf3a0ba16) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://snappy.forge.ocamlcore.org/";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["snappy_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-x"; "c++"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lsnappy"])];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "snappy"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "http://git.ocamlcore.org/snappy/snappy.git";
                      src_repo_browser =
                        Some
                          "http://git.ocamlcore.org/cgi-bin/gitweb.cgi?p=snappy/snappy.git";
     ...
     oasis_digest = Some "%\243\139\174l'\202$\239\158\162\182@\248\222\251";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
